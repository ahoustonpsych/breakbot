...
function upkeepOnBreak() {
    return new Promise(function (fulfill, reject) {
        ...
        for (let user in breaks.onbreak) {
        ...
        requests.getAgentStatus(user)
            .then(function (res) {
                ...
                if (res === 'accepting chats') {
                    delete breaks.out[user];
                    console.log(new Date().toLocaleString() + ' ' + user + ' silently changed status to: ' + res + '. deleting break data.');
                }
                else {
                    console.log(new Date().toLocaleString() + ' ' + user + ': ' + res);
                }
...
function checkLunch() {
    ...
    for (let user in luncher.schedule) {
